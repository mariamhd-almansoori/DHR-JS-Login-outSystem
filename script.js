...
function submitForm(type) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbwTXMKaVhmcNxrmcozQR8mO2Xmv1Vhjqt2FaWp4Z5c_fl54TbWfsMfMqQqXCCmfnoZdkA/exec', {  // استبدل 'your-web-app-url' بالرابط الذي حصلت عليه من نشر Google Apps Script
        method: 'POST',
        headers: {
